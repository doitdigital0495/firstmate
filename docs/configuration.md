...
The re-derivation is a read-only runtime query made before any mutation, and it refuses whenever the label cannot be proven to belong to exactly that recorded endpoint.
