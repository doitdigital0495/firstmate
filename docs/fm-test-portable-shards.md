...
| portable serial 1-6 | job `timeout-minutes: 30` | Current runners have taken about 20 minutes for a balanced shard, so the 30-minute cap stays a hang tripwire while leaving margin for job setup and runner-speed spread. |
