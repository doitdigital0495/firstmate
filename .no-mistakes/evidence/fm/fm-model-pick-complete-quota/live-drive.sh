...
drive "B one-unmeasured-candidate-incomplete (cursor live state=error)" '{"rules":[{"when":"A bug fix.","use":[{"harness":"claude","model":"sonnet","effort":"high"},{"harness":"cursor","model":"cursor-grok-4.6-medium"}]}]}'
drive "C auth_required-provider-only-incomplete (kimi)" '{"rules":[{"when":"A bug fix.","use":[{"harness":"kimi","model":"kimi-code/k3"}]}]}'
drive "D profile-floor-on-unmeasured-provider (codex gated by cursor floor)" '{"rules":[{"when":"A bug fix.","use":[{"harness":"codex","model":"gpt-5.6-sol","floor":{"scope":"all_models","min_percent":10,"provider":"cursor"}},{"harness":"claude","model":"sonnet"}]}]}'
